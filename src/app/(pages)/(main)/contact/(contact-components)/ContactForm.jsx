    ...
    <section className={styles.contactForm}>
      ...
      <form className={styles.contactForm__form}>
        <div className={styles.contactForm__form__grid}>
          ...
          <div className={styles.contactForm__form__block}>
            <label htmlFor="email" className={styles.contactForm__form__label}>
              Email
            </label>
            <input
              className={styles.contactForm__form__input}
          ...
          <div className={styles.contactForm__form__block}>
            <label htmlFor="phone" className={styles.contactForm__form__label}>
              Telefone
            </label>
            <input
              className={styles.contactForm__form__input}
        ...
        <div className={styles.contactForm__form__block}>
          <label htmlFor="message" className={styles.contactForm__form__label}>
            Mensagem
          </label>
          <textarea
            id="message"
